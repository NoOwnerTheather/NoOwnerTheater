# Generated by Django 4.0.1 on 2022-02-07 04:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.CharField(choices=[('드라마', '드라마'), ('사극', '사극'), ('미스터리', '미스터리'), ('공포(호러)', '공포(호러)'), ('가족', '가족'), ('뮤지컬', '뮤지컬'), ('판타지', '판타지'), ('성인물(에로)', '성인물(에로)'), ('스릴러', '스릴러'), ('코미디', '코미디'), ('전쟁', '전쟁'), ('다큐멘터리', '다큐멘터리'), ('범죄', '범죄'), ('액션', '액션'), ('애니메이션', '애니메이션'), ('SF', 'SF'), ('멜로/로맨스', '멜로/로맨스')], max_length=100, verbose_name='장르')),
