    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.CharField(choices=[('멜로/로맨스', '멜로/로맨스'), ('공포(호러)', '공포(호러)'), ('스릴러', '스릴러'), ('코미디', '코미디'), ('성인물(에로)', '성인물(에로)'), ('사극', '사극'), ('SF', 'SF'), ('다큐멘터리', '다큐멘터리'), ('전쟁', '전쟁'), ('드라마', '드라마'), ('판타지', '판타지'), ('범죄', '범죄'), ('애니메이션', '애니메이션'), ('가족', '가족'), ('뮤지컬', '뮤지컬'), ('미스터리', '미스터리'), ('액션', '액션')], max_length=100, verbose_name='장르')),
