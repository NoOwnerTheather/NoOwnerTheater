# Generated by Django 3.2.12 on 2022-02-11 13:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('여자', '여자'), ('남자', '남자')], max_length=20, verbose_name='성별')),
                ('user_img', models.FileField(default='imgs/2.PNG', upload_to='', verbose_name='유저사진')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.CharField(choices=[('멜로/로맨스', '멜로/로맨스'), ('코미디', '코미디'), ('SF', 'SF'), ('액션', '액션'), ('전쟁', '전쟁'), ('스릴러', '스릴러'), ('가족', '가족'), ('범죄', '범죄'), ('공포(호러)', '공포(호러)'), ('미스터리', '미스터리'), ('성인물(에로)', '성인물(에로)'), ('사극', '사극'), ('판타지', '판타지'), ('다큐멘터리', '다큐멘터리'), ('뮤지컬', '뮤지컬'), ('드라마', '드라마'), ('애니메이션', '애니메이션')], max_length=100, verbose_name='장르')),
