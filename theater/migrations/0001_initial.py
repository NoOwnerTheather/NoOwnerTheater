    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.CharField(choices=[('전쟁', '전쟁'), ('가족', '가족'), ('애니메이션', '애니메이션'), ('드라마', '드라마'), ('스릴러', '스릴러'), ('멜로/로맨스', '멜로/로맨스'), ('범죄', '범죄'), ('성인물(에로)', '성인물(에로)'), ('SF', 'SF'), ('판타지', '판타지'), ('코미디', '코미디'), ('사극', '사극'), ('다큐멘터리', '다큐멘터리'), ('뮤지컬', '뮤지컬'), ('미스터리', '미스터리'), ('액션', '액션'), ('공포(호러)', '공포(호러)')], max_length=100, verbose_name='장르')),
