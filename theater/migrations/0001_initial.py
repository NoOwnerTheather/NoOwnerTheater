# Generated by Django 3.2.12 on 2022-02-10 13:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_img', models.FileField(upload_to='imgs/1.PNG', verbose_name='유저사진')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.CharField(choices=[('범죄', '범죄'), ('성인물(에로)', '성인물(에로)'), ('SF', 'SF'), ('다큐멘터리', '다큐멘터리'), ('멜로/로맨스', '멜로/로맨스'), ('미스터리', '미스터리'), ('스릴러', '스릴러'), ('드라마', '드라마'), ('판타지', '판타지'), ('뮤지컬', '뮤지컬'), ('가족', '가족'), ('코미디', '코미디'), ('애니메이션', '애니메이션'), ('사극', '사극'), ('전쟁', '전쟁'), ('액션', '액션'), ('공포(호러)', '공포(호러)')], max_length=100, verbose_name='장르')),
