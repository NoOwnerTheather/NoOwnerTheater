# Generated by Django 4.0.2 on 2022-02-11 16:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.CharField(choices=[('뮤지컬', '뮤지컬'), ('판타지', '판타지'), ('멜로/로맨스', '멜로/로맨스'), ('액션', '액션'), ('사극', '사극'), ('코미디', '코미디'), ('범죄', '범죄'), ('전쟁', '전쟁'), ('공포(호러)', '공포(호러)'), ('미스터리', '미스터리'), ('스릴러', '스릴러'), ('다큐멘터리', '다큐멘터리'), ('드라마', '드라마'), ('성인물(에로)', '성인물(에로)'), ('가족', '가족'), ('SF', 'SF'), ('애니메이션', '애니메이션')], max_length=100, verbose_name='장르')),
