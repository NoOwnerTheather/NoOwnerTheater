# Generated by Django 3.2.12 on 2022-02-11 21:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_img', models.FileField(default='imgs/1.PNG', upload_to='', verbose_name='유저사진')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.CharField(choices=[('액션', '액션'), ('사극', '사극'), ('코미디', '코미디'), ('애니메이션', '애니메이션'), ('멜로/로맨스', '멜로/로맨스'), ('판타지', '판타지'), ('다큐멘터리', '다큐멘터리'), ('뮤지컬', '뮤지컬'), ('가족', '가족'), ('스릴러', '스릴러'), ('공포(호러)', '공포(호러)'), ('미스터리', '미스터리'), ('성인물(에로)', '성인물(에로)'), ('SF', 'SF'), ('드라마', '드라마'), ('범죄', '범죄'), ('전쟁', '전쟁')], max_length=100, verbose_name='장르')),
