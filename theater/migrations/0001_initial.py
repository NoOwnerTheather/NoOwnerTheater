    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_img', models.TextField(default='/static/img/user3.PNG', verbose_name='유저사진')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.CharField(choices=[('SF', 'SF'), ('멜로/로맨스', '멜로/로맨스'), ('가족', '가족'), ('미스터리', '미스터리'), ('드라마', '드라마'), ('코미디', '코미디'), ('판타지', '판타지'), ('애니메이션', '애니메이션'), ('액션', '액션'), ('다큐멘터리', '다큐멘터리'), ('뮤지컬', '뮤지컬'), ('범죄', '범죄'), ('전쟁', '전쟁'), ('스릴러', '스릴러'), ('공포(호러)', '공포(호러)'), ('사극', '사극'), ('성인물(에로)', '성인물(에로)')], max_length=100, verbose_name='장르')),
