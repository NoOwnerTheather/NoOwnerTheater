    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.CharField(choices=[('SF', 'SF'), ('뮤지컬', '뮤지컬'), ('액션', '액션'), ('성인물(에로)', '성인물(에로)'), ('전쟁', '전쟁'), ('가족', '가족'), ('애니메이션', '애니메이션'), ('공포(호러)', '공포(호러)'), ('사극', '사극'), ('판타지', '판타지'), ('코미디', '코미디'), ('스릴러', '스릴러'), ('멜로/로맨스', '멜로/로맨스'), ('범죄', '범죄'), ('다큐멘터리', '다큐멘터리'), ('드라마', '드라마'), ('미스터리', '미스터리')], max_length=100, verbose_name='장르')),
