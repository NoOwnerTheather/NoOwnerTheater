# Generated by Django 4.0.1 on 2022-02-15 01:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_img', models.TextField(default='/static/img/user2.PNG', verbose_name='유저사진')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.CharField(choices=[('애니메이션', '애니메이션'), ('미스터리', '미스터리'), ('가족', '가족'), ('드라마', '드라마'), ('멜로/로맨스', '멜로/로맨스'), ('다큐멘터리', '다큐멘터리'), ('사극', '사극'), ('SF', 'SF'), ('성인물(에로)', '성인물(에로)'), ('액션', '액션'), ('뮤지컬', '뮤지컬'), ('공포(호러)', '공포(호러)'), ('판타지', '판타지'), ('범죄', '범죄'), ('스릴러', '스릴러'), ('전쟁', '전쟁'), ('코미디', '코미디')], max_length=100, verbose_name='장르')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.FloatField(choices=[(0.5, 0.5), (1.0, 1.0), (1.5, 1.5), (2.0, 2.0), (2.5, 2.5), (3.0, 3.0), (3.5, 3.5), (4.0, 4.0), (4.5, 4.5), (5.0, 5.0)], verbose_name='평점')),
